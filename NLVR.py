...
from models.model_nlvr import XFMForNLVR
...
def main(args, config):
    ...
    model = XFMForNLVR(config=config)
    ...
    if args.evaluate:
        ...
        if utils.is_main_process():
            ...
            print(f"### data {train_dataset_size}, batch size, {train_batch_size} x {world_size} x {accumulate_steps}")
