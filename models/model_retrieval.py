...
class XFMForRetrieval(XFMBase):
    ...
    def forward(self, image, text_ids, text_atts, idx=None):
        ...
        text_embeds = self.get_text_embeds(text_ids, text_atts)  # 12L cross encoder w/o image input
        ...
        loss_itm = self.get_matching_loss(image_embeds, image_atts, image_feat,
                                          text_ids, text_atts, text_feat, idx=idx, 
                                          text_embeds=text_embeds, is_pretrain=False)  # 12L cross encoder
